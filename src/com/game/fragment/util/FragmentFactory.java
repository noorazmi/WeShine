...
public class FragmentFactory {
   ...
   public static void attachGameLevelTwoFragment(Activity activity, Bundle bundle){
	   FragmentHelper.addFragmentOnBackStack(new WeakReference<MazeActivity>((MazeActivity) activity), new MazeGame2Fragment(), null, FragmentTag.FragmentMazeGame2.getTag());
   }
   
   public static void attachGameLevelThreeFragment(Activity activity, Bundle bundle){
	   FragmentHelper.addFragmentOnBackStack(new WeakReference<MazeActivity>((MazeActivity) activity), new MazeGame3Fragment(), null, FragmentTag.FragmentMazeGame3.getTag());
   }
   
   public static void attachGameLevelFourFragment(Activity activity, Bundle bundle){
	   FragmentHelper.addFragmentOnBackStack(new WeakReference<MazeActivity>((MazeActivity) activity), new MazeGame4Fragment(), null, FragmentTag.FragmentMazeGame4.getTag());
   }
   
   public static void attachGameLevelFiveFragment(Activity activity, Bundle bundle){
	   FragmentHelper.addFragmentOnBackStack(new WeakReference<MazeActivity>((MazeActivity) activity), new MazeGame5Fragment(), null, FragmentTag.FragmentMazeGame5.getTag());
   }
	...
	public static void attachGameEndVideoFragment(Activity activity, Bundle bundle) {
		...
		FragmentHelper.addFragmentOnBackStack(new WeakReference<MazeActivity>((MazeActivity) activity), new GameEndVideoFragment(), bundle, FragmentTag.FragmentGameEndVideo.getTag());
	}
