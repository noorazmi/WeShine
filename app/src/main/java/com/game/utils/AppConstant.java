...
public interface AppConstant {
	...
	public static final int MAZE_ONE_VIDEO_DURATION = 10000;//Milli Seconds
	public static final int MAZE_TWO_VIDEO_DURATION = 11000;//Milli Seconds
	public static final int MAZE_THREE_VIDEO_DURATION = 14000;//Milli Seconds
	public static final int MAZE_FOUR_VIDEO_DURATION = 13000;//Milli Seconds
